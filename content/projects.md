...
<a href="https://sharedgarden.io/" target="_blank">Shared Garden</a> is a collaborative, real-time multiplayer web application where users work together to tend a shared digital garden. Players choose from roles to perform gardening actions and affect the shared game state.
